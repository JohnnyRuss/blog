    ...
    >
      <li className="editor-pick__item">
        ...
        <div className="editor-pick__item-content">
          ...
          >
            ...
            asperiores, accusantium quod, ea exercitationem molestiae fugit
            suscipit facilis, aut sunt ipsa molestias cupiditate? Perspiciatis
            ipsam aliquam laboriosam porro consequuntur est.
          </LineClamp>
      ...
      <li className="editor-pick__item">
        ...
        <div className="editor-pick__item-content">
          ...
          <div className="editor-pick__item-footer">
            <span className="editor-pick__item-footer--author">Saly Obman</span>
            &mdash;
